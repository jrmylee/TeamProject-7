...
public class TestFleur {
	...
	public static void main(String[] args) {
		...
		System.out.println("Fleur with three vertices:");
		fillFleur(fleur_graph, 3);
		runTests(fleur_graph);
		
		// Five Vertices, Complete Graph
		System.out.println("Fleur with five vertices:");
		fillFleur(fleur_graph, 5);
		runTests(fleur_graph);
		
		// Two Vertices, Complete Graph
		System.out.println("Fleur with two vertices:");
		fillFleur(fleur_graph, 2);
		runTests(fleur_graph);
		
		// One Vertex, Complete Graph
		System.out.println("Fleur with one vertex:");
		fillFleur(fleur_graph, 1);
		runTests(fleur_graph);
		
		// Disconnected Graph, All even Vertices
		System.out.println("Fleur with even, but disconnected, vertices");
		fillFleurDisconnected(fleur_graph);
		runTests(fleur_graph);
				
		// Two odd vertices
		System.out.println("Fleur with two odd vertices:");
		fillFleur(fleur_graph, 3);
